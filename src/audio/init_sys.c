...
// Initialize vpipe structures...
	...
	vid_rsptask.t.ucode = (u64 *)gspFast3D_fifoTextStart;
	vid_rsptask.t.ucode_size = SP_UCODE_SIZE;
	vid_rsptask.t.ucode_data = (u64 *)gspFast3D_fifoDataStart;
...
#if 0
	wess_config.abuf_vstart = OS_PHYSICAL_TO_K0( SYS_MEMMAP_AUDIOBUFS );
	wess_config.abuf_bytes = SYS_ABUF_SIZE;
	wess_config.workfreq = SYS_AUDIO_WORKFREQ;
	wesstest_init( &wess_config );
#endif
