...
#define FX_NOOB_EGO_EXP		0x35		
#define FX_SMOKE_LIGHTNING	0x36
#define FX_BRUTALITY		0x37
#define FX_AGRESSOR			0x38
#define FX_INVISO_POOF_NS	0x39
...
void gravity_explode(GEXPLODE *,BYTE *dict,void *);
void spawn_1_piece(GEXPLODE *,short,short,WORD,BYTE *dict,void *);
#define special_gravity_explode(_exp,_dict) gravity_explode(_exp,_dict,0)
//-SONY- void special_gravity_explode(GSEXPLODE *);
//-SONY- void special_spawn_1_piece(GSEXPLODE *,short,short,WORD);
