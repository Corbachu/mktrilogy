...
/* transform offsets */
#define TRANSFORM_OLDSMOKE	0
#define TRANSFORM_SK		1
#define TRANSFORM_MOTARO	2

typedef struct 
{
	WORD trans_mask;		// joystick mask
	WORD trans_act;			// joystick activation
	FUNC trans_routine;		// routine to execute
} TRANS;
...
#define M_P1D	(MASK_JDOWN)
#define M_P2D	(MASK_JDOWN)
#define M_P1U	(MASK_JUP)
#define M_P2U	(MASK_JUP)
