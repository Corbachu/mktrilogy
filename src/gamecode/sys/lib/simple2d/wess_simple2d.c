...
#define sys_master_sfx_volume_get S2D_GetSoundMixVolume 
#define sys_master_mus_volume_get S2D_GetMusicVolume
#define sys_master_sfx_vol_set S2D_SetSoundMixerVolume
#define wess_master_mus_vol_set S2D_SetMusicVolume
