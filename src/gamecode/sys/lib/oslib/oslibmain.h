/******************************************************************************
 ...
 Mortal Kombat III oslibmodv2 SPECIFIC STUFF
******************************************************************************/

#ifndef __mk_oslibmain_h__
#define __mk_oslibmain_h__
...
#define DECOMP_BUFFER_SIZE	(1024*255)			/* # of bytes in image decomp buffer */
