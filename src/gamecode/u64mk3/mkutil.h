...
OBJECT *get_single_obj(LONG,BYTE *dict,void *,void *,WORD);
...
#define gso_dmawnz(_obj,_frm,_dict,_heap,_pal) (_obj)=get_single_obj((_frm),(_dict),(_heap),(_pal),PFLAG_PALLOAD)

/* gso_dmawnz_ns, no dma flags to worry about, bypass setting, ns=noscroll*/
#define gso_dmawnz_ns(_obj,_frm,_dict,_heap,_pal)  (_obj)=get_single_obj((_frm),(_dict),(_heap),(_pal),PFLAG_PALLOAD), set_noscroll(_obj)

/* gso_dmawnz_coor, no dma flags to worry about, bypass setting & set coords*/
#define gso_dmawnz_coord(_obj,_frm,_dict,_heap,_pal,_x,_y)  \
				{ \
				(_obj)=get_single_obj((_frm),(_dict),(_heap),(_pal),PFLAG_PALLOAD); \
				set_xy_coordinates((_obj),(_x),(_y)) \
				}

/* gso_dmawnz_ns_coor, no dma flags to worry about, bypass setting & set coords*/
#define gso_dmawnz_ns_coor(_obj,_frm,_dict,_heap,_pal,_x,_y)  \
				{ \
				(_obj)=get_single_obj((_frm),(_dict),(_heap),(_pal),PFLAG_PALLOAD); \
				set_xy_coordinates((_obj),(_x),(_y)); \
				set_noscroll(_obj); \
...
#define get_single_obj_np(_frm,_dict,_heap,_pal) get_single_obj((_frm),(_dict),(_heap),(_pal),PFLAG_CLEAR)

#define gso_dmawnz_np(_obj,_frm,_dict,_heap,_pal) (_obj)=get_single_obj_np((_frm),(_dict),(_heap),(_pal))
