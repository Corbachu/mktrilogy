...
char txt_switcheroo[]="RANDPER KOMBAT";
...
char txt_see_da_tour[]="PLAY UMK3 WAVENET AT A LOCAL ARCADE";
char txt_curback_subway[]="KOMBAT ZONE: SUBWAY";
char txt_curback_street[]="KOMBAT ZONE: STREET";
char txt_curback_ktower[]="KOMBAT ZONE: KAHNS TOWER";
...
char txt_curback_hell[]="KOMBAT ZONE: SCORPIONS LAIR";
char txt_curback_lost[]="KOMBAT ZONE: LOST BRIDGE";
char txt_curback_mk2pit[]="KOMBAT ZONE: THE PIT II";
char txt_curback_mk2pitstar[]="KOMBAT ZONE: THE STAR BRIDGE";
char txt_curback_kkave[]="KOMBAT ZONE: KAHNS KAVE";
char txt_curback_desert[]="KOMBAT ZONE: JADES DESERT";
char txt_curback_hidden[]="KOMBAT ZONE: THE HIDDEN PORTAL";
char txt_curback_deadpool[]="KOMBAT ZONE: THE DEADPOOL";
char txt_curback_battle[]="KOMBAT ZONE: WASTELAND";
char txt_curback_city[]="KOMBAT ZONE: THE ROOFTOP";
char txt_curback_armory[]="KOMBAT ZONE: THE ARMORY";
char txt_curback_forest[]="KOMBAT ZONE: LIVING FOREST";
char txt_curback_tower[]="KOMBAT ZONE: THE TOWER";
char txt_curback_monk[]="KOMBAT ZONE: THE PORTAL";
char txt_curback_lair[]="KOMBAT ZONE: THE LAIR";
char txt_curback_tomb[]="KOMBAT ZONE: THE TOMB";
char txt_curback_kung2[]="KOMBAT ZONE: THE COURTYARD";
char txt_curback_kung5[]="KOMBAT ZONE: THE PIT";
char txt_curback_kung5bot[]="KOMBAT ZONE: THE PIT BOTTOM";
...
char rom_name[]="NINTENDO REV 2.0";
...
char txt_bloody[]="BLOODY KOMBAT";
char txt_auto_combo[]="AUTOMATIC KOMBOS";
char txt_baby_clue[]="BABALITIES ARE REVERSABLE!";
char txt_mk_clue[]="PREPARE FOR MORTAL KOMBAT IV";
char txt_willy_kombat[]="WILLY WEST KOMBAT";
char txt_snow[]="RAINS COUNTERPART IS SNOW";
	...
	if (kode_offset>=0) 
	{
		switch (kode_offset)
		{
			...
			case 24:	// street
				...
				break;
			case 25:	// pit
				r_force_curback(txt_curback_city,BKGD_CITY_MOD);
				break;
			case 26:	// ktower
			...
			case 56:	// real kombat
				...
				break;
			case 57:		// pong game
				CREATE(PID_MASTER,pong_game);
				msg1(txt_pong);
				break;
			case 58:	// monk arena
				r_force_curback(txt_curback_kung2,BKGD_KUNGFU2_MOD);
				break;
			case 59:	// deadpool
				r_force_curback(txt_curback_deadpool,BKGD_DEADPOOL_MOD);
				break;
			case 60:	// wasteland
				r_force_curback(txt_curback_battle,BKGD_BATTLE_MOD);
				break;
			case 61:	// kanhsareana
				r_force_curback(txt_curback_kung5,BKGD_KUNGFU5_MOD);
				break;
			case 62:	// armory
				r_force_curback(txt_curback_armory,BKGD_ARMORY_MOD);
				break;
			case 63:	// forest
				r_force_curback(txt_curback_forest,BKGD_FOREST_MOD);
				break;
			case 64:	// tower
				r_force_curback(txt_curback_tower,BKGD_SKTOWER_MOD);
				break;
			case 65:	// portal
				r_force_curback(txt_curback_monk,BKGD_MONK_MOD);
				break;
			case 66:	// lair
				r_force_curback(txt_curback_lair,BKGD_LAIR_MOD);
				break;
			case 67:	// tomb
				r_force_curback(txt_curback_tomb,BKGD_TOMB_MOD);
				break;
			case 68:	// mk2 pit
				r_force_curback(txt_curback_mk2pit,BKGD_MK2PIT_MOD);
				break;
			case 69:	// mk2 pit
				r_force_curback(txt_curback_mk2pitstar,BKGD_MK2PITSTAR_MOD);
				break;
			case 70:	// bloody kombat
				f_bloody_kombat=1;
				msg1(txt_bloody);
				break;
			case 71:	// auto combos
				...
				msg1(txt_auto_combo);
				break;
			case 72:	// winner fights kmel
				wf3(txt_wf_kamel,post_wf_kamel);
				break;
			case 73:	// pit bottom
				r_force_curback(txt_curback_kung5bot,BKGD_KUNGFU5BOT_MOD);
				break;
			case 74:	// baby reverse
				msg1(txt_baby_clue);
				break;
			case 75:	// mk klue1
				msg1(txt_mk_clue);
				break;
			case 76:	// willy west kombat
				CREATE(PID_SWITCHEROO,switcheroo_proc);
				CREATE(PID_REGENERATE,regenerate_proc);
				msg1(txt_willy_kombat);
				break;
			case 77:		// jackbot 
				msg1(txt_snow);
				break;
...
#endif
	(char *)CREATE(PID_R1,msg_round1)->pa8=msg;
...
void msg_round1(void)
{
	...
	p7_centered((char *)current_proc->pa8,SCX(0xc8),SCY(0xf0)+8);
...
void switcheroo_proc(void)
{
	do
	{
		...
		current_proc->pdata.p_store1=randu(16)+1;
		current_proc->pdata.p_store2=randu(16)+1;
		
		if (current_proc->pdata.p_store1==current_proc->pdata.p_store2) 
		{
			if (random() & 0x8000)
				current_proc->pdata.p_store1+=randu(7)+1;
			else current_proc->pdata.p_store2+=randu(7)+1;
		}

		/* switcher3 */
		while (p1_bar!=0 && p2_bar!=0)		// zero power = dont switch
		{
			if (f_thatsall!=0)
			...
			switcheroo_check(&(current_proc->pdata.p_store1),current_proc->pdata.p_store2);

			current_proc->pa8=p2_obj;
			current_proc->a5=(ADDRESS)p2_proc;
			switcheroo_check(&(current_proc->pdata.p_store2),current_proc->pdata.p_store1);
		}
	}
	while(1);
}
...
void dark_velocities(void)
{
	...
	do
	{
		...
		/* -NOTE- SONY CODE SPACE AT 0x80000000 */
