...
#define NUM_OBJECTS 380			/* total # of objects for display lists */
...
/* floor code stuff */
//-SONY- #define FLR_BUFFER_X 160					/* half of the floor draw area */
#define FLR_BUFFER_X 320					/* floor draw area */
#define FLR_BUFFER_Y FLOOR_Y				/* height of floor buffer */

/* oflags */

/* sony remap of above flags from arcade */
#define M_XLU_ON		0x0001				// set if xlu to apply to obj
#define M_BOX_POLY		0x0002				// draw a solid box
//#define M_PLAYER_BUF1	0x0004				// object uses player 1 buffer in vram
//#define M_PLAYER_BUF2	0x0008				// object uses player 2 buffer in vram
#define M_RED_TINT		0x0004
...
#define M_CLIP			0x0080				// set if use clipping value (ofset) (8Right:8Left)

#define M_PAL			0xff00

#define M_XLU_VALUE		0xff00				// XLU value offset
#define M_XLU_SHIFT		8				// # of bits to get value in lower bits

#define QUARTER_XLU			0x4000
#define HALF_XLU			0x8000
#define THREE_QUARTER_XLU	0xbf00
...
#define M_DEAD		0x8000		/* set if dead on ground */
...
/* floor ram */
__EXTERN__ long long floor_draw_buf[FLR_BUFFER_X*FLR_BUFFER_Y/sizeof(long long)];	// align  __attribute__ ((aligned (4)));		// draw buffer of active floor
