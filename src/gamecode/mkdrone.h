...
#define c_snot_lo c_swat_bomb_lo
#define c_snot_hi c_swat_bomb_hi
...
#define c_sk_zap c_st_zap1
#define c_mot_zap c_st_zap1
#define c_sa_spark c_st_zap1   
#define c_rd_bolt c_st_zap1	   
#define c_noob_zap c_st_zap1	   
#define c_rain_zap c_st_zap1
...
void raiden_counter_zap(void);	//-u64-
...
#define c_sk_charge_sd c_jaxdash_sd
...
#define c_sk_aircharge_sd c_sbike_sd
void c_zoom_sd(void);
...
#define c_mot_tele c_tele_explode
