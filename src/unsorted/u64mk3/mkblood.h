...
#define BLOOD_BOOMER		0x0b
#define BLOOD_SPEAR			0x0c
#define BLOOD_SHRED			0x0d	//-u64-
#define BLOOD_SPIKE_DRIP	0x0e
#define BLOOD_STABBED		0x0f
#define BLOOD_SPIKE			0x10
 ...
 *	PROTOTYPES 
 */
void create_blood_proc(WORD);

void shred_drip(void);		//-u64-
void blood_shred(void);		//-u64-
