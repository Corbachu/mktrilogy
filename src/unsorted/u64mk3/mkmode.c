...
//	pds_coin(&baklst5,txt_mkcoin3b,280,134);
	gso_dmawnz_ns(obj,(ADDRESS)CP_TOURNA,nucoin_dict,0,0);
	alloc_cache(CP_TOURNA,0,obj);
	obj->ozval=0;
	set_xy_coordinates(obj,253-4-9+3,134-32-14+7);
	insert_object(obj,&baklst5);

	gso_dmawnz_ns(obj,(ADDRESS)CP_MENT,nucoin_dict,0,0);
	alloc_cache(CP_MENT,0,obj);
	obj->ozval=0;
	set_xy_coordinates(obj,253-4-9+3+10,134-32+7);
	insert_object(obj,&baklst5);

	gso_dmawnz_ns(obj,(ADDRESS)CP_KOMBAT,nucoin_dict,0,0);
	alloc_cache(CP_KOMBAT,0,obj);
	obj->ozval=0;
	set_xy_coordinates(obj,253-4-9+3,148-32+7);
	insert_object(obj,&baklst5);
