...
OPTLIST cheat_opts3[]=
{
	{OID_OPT_ID1,(WORD *)&f_level_select,OPT_TOP_Y+30*0,OPT_TOP_X_L,OPT_TOP_X_C,opt_txt_level,opt_off_on,option_toggle,0},			// blood
	{OID_OPT_ID2,(WORD *)&f_opt_throws,OPT_TOP_Y+30*1,OPT_TOP_X_L,OPT_TOP_X_C,opt_txt_throws,opt_en_dis,option_toggle,0},			// blood
	{OID_OPT_ID3,(WORD *)&f_opt_runs,OPT_TOP_Y+30*2,OPT_TOP_X_L,OPT_TOP_X_C,opt_txt_runs,opt_dis_en,option_toggle,0},			// blood
	{OID_OPT_ID4,(WORD *)&f_opt_bloody,OPT_TOP_Y+30*3,OPT_TOP_X_L,OPT_TOP_X_C,opt_txt_bloody,opt_off_on,option_toggle,0},			// blood
	{OID_OPT_ID5,NULL,OPT_TOP_Y+30*5,OPT_EXIT_X,OPT_EXIT_X,opt_txt_exit,NULL,option_exit,0}							// exit
};
...
#define SCREEN_ADJ_YMAX	32
#define SCREEN_ADJ_XMAX	32
#define SCREEN_DEBOUNCE	3
char txt_centered[]="USE JOYPAD TO CENTER\nSCREEN. PRESS ANY BUTTON\nWHEN FINISHED";
