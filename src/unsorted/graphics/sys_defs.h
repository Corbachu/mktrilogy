...
#define SYS_DEBUG			1		/* 1=turn debugging code on, 0=no debugging code (retail) */
#define SYS_VERBOSE			1		/* 0=quiet, 1=minimum printing, 2=moderate printing, 3=maximum printing */
...
#define SYS_CARTRIDGE_SIZE		8192		/* Cartridge size in kilobytes */
...
#define SYS_DRAM_MAX			0x3fffff	/* Last addressable byte in DRAM */
...
#define SYS_NUM_FRAMEBUFS		3				/* Number of frame buffers (2 or 3) */
#define SYS_NUM_DLBUFS			3				/* Number of display-list buffers (2 or 3) */
...
#define SYS_IDLE_STACKSIZE			512
#define SYS_MAIN_STACKSIZE			2048
#define SYS_ROMCOPY_STACKSIZE		2048
#define SYS_VBI_STACKSIZE			3072
//#define SYS_RSP_STACKSIZE			2048
//#define SYS_RDP_STACKSIZE			2048
#define SYS_GAMEPAD_STACKSIZE		2048
#define SYS_GTIMER_STACKSIZE		2048
...
#define SYS_MSGBUF_SIZE_PI		200
#define SYS_MSGBUF_SIZE_VID		60
