...
{
	{-SCX(0x40),SCY(0x00)},	// hathead
	{-SCX(0x4a),SCY(0x08)},	// kang
	{-SCX(0x48),SCY(0x00)},	// cage
	{-SCX(0x48),SCY(0x00)},	// sword arms

	{-SCX(0x48),SCY(0x00)},	// knockout
	{-SCX(0x48),SCY(0x00)},	// bombshell
	{-SCX(0x48),SCY(0x00)},	// shang tsung
	{-SCX(0x48),SCY(0x00)},	// raiden

	{-SCX(0x48),SCY(0x00)},	// sub-zero
	{-SCX(0x48),SCY(0x00)},	// reptile
	{-SCX(0x48),SCY(0x00)},	// scorpion
	{-SCX(0x50),SCY(0x00)},   	// jax
	{-SCX(0x60),SCY(0x00)},  	// kintaro
	{-SCX(0x48),-SCY(0x14)},      	// shao kahn
...
void prop_do_noob_slam(void)
{
	...
	do
	{
		...
		if (get_y_dist<SCY(0x20) && get_x_dist<SCX(0x30)) 
		{
			...
			if (is_he_blocking(&duck,0)==SYSTEM_CARRY_SET && q_am_i_noob_zap()==SYSTEM_CARRY_CLR || (current_proc->pdata.p_otherguy)->ochar==FT_MOTARO)
				break;
			goto TELESLAM_HIT;
		}
...
void prop_ind_charge(void)
{
	...
	create_fx(FX_TRAIL)->pdata.p_store8=0;
